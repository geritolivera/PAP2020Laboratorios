...
public class AltaUsuario extends JInternalFrame {
		...
		if(checkFormulario()) {
			try {
				if(!instituto.isEmpty()) {
					JOptionPane.showMessageDialog(this, "El Docente se ha creado con �xito", "Alta Usuario", JOptionPane.INFORMATION_MESSAGE);
					this.icon.AltaUsuario(nickname, nombre, apellido, email, dateChooser, instituto);
				} else {
					JOptionPane.showMessageDialog(this, "El Estudiante se ha creado con �xito", "Alta Usuario", JOptionPane.INFORMATION_MESSAGE);
	...
	private boolean checkFormulario() {
		...
		if(nickname.isEmpty() || nombre.isEmpty() || apellido.isEmpty() || email.isEmpty() || fechaString.isEmpty()) {
			JOptionPane.showMessageDialog(this, "No puede haber campos vac�os", "Alta Usuario", JOptionPane.ERROR_MESSAGE);
            return false;
		}
